...
module.exports = !__webpack_require__(49) && !__webpack_require__(92)(function () {
  return Object.defineProperty(__webpack_require__(348)('div'), 'a', { get: function get() {
      return 7;
    } }).a != 7;
});
...
var _getOwnPropertyDescriptor = __webpack_require__(349);
...
var $getOwnPropertyDescriptor = __webpack_require__(355).f;

__webpack_require__(358)('getOwnPropertyDescriptor', function () {
  return function getOwnPropertyDescriptor(it, key) {
    return $getOwnPropertyDescriptor(toIObject(it), key);
  };
});
...
var _config = __webpack_require__(361);

var _dataset = __webpack_require__(362);
...
var News = function () {
    ...
    _createClass(News, [{
        ...
        value: function init(node) {
            ...
            _config.GET_ALL_CHANELL_BUTTON.addEventListener('click', function (e) {
                var target = e.target;
        ...
        value: function sendRequest(source) {
            ...
            fetch(url).then(function (response) {
                return _this2.parseJSON(response);
            }).then(function (data) {
        ...
        value: function render(_ref) {
            ...
            stringNodes.map(function (el) {
                return _config.NEWS_BLOCK.insertAdjacentHTML('afterbegin', el);
            });
        }
    }, {
        key: 'parseData',
        ...
        */
        value: function buildUrl(source) {
            if (source && source.length > 0) {
                return '' + _config.URL + source + '&apiKey=' + _config.API_KEY;
            }
        }
    }]);
...
document.addEventListener('DOMContentLoaded', function (e) {
    ...
    newsInstance.init(_config.ROOT_NODE);
}, false);
...
var API_KEY = exports.API_KEY = '8eef20059fff4d46b5a8712e64d166f6';
var URL = exports.URL = 'https://newsapi.org/v2/top-headlines?sources=';
var ROOT_NODE = exports.ROOT_NODE = document.querySelector('.content');
var NEWS_BLOCK = exports.NEWS_BLOCK = ROOT_NODE.querySelector('.news-block');
var GET_ALL_CHANELL_BUTTON = exports.GET_ALL_CHANELL_BUTTON = ROOT_NODE.querySelector('.sources-block');
...
function datasetModule(global, definition) {
    ...
    if ("function" === 'function' && __webpack_require__(363)[amd]) {
